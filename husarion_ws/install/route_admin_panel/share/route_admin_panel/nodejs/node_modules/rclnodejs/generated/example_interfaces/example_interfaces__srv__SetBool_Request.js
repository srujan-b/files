...
class SetBool_RequestWrapper {
  ...
  static type() {
    return {pkgName: 'example_interfaces', subFolder: 'srv', interfaceName: 'SetBool_Request'};
  }
  static isPrimitive() {
    return false;
  }
...
class SetBool_RequestArrayWrapper {
  ...
  fill(values) {
    ...
    values.forEach((value, index) => {
      if (value instanceof SetBool_RequestWrapper) {
        this._wrappers[index].copy(value);
      } else {
        this._wrappers[index] = new SetBool_RequestWrapper(value);
      }
    });
  }
