...
class PointFieldArrayWrapper {
  ...
  fill(values) {
    ...
    values.forEach((value, index) => {
      if (value instanceof PointFieldWrapper) {
        this._wrappers[index].copy(value);
      } else {
        this._wrappers[index] = new PointFieldWrapper(value);
      }
    });
  }
