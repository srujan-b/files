...
class SpawnEntity_RequestWrapper {
  constructor(other) {
    ...
    if (typeof other === 'object' && other._refObject) {
      ...
      this._xmlIntialized = true;
      this._wrapperFields.xml =  new StringWrapper(other._wrapperFields.xml);
  ...
  _initMembers() {
    ...
    this._xmlIntialized = false;
    this._wrapperFields.xml = new StringWrapper();
  ...
  freeze(own = false, checkConsistency = false) {
    if (checkConsistency) {
      if (!this._nameIntialized) {
        throw new TypeError('Invalid argument: name in SpawnEntity_Request');
      }
      if (!this._xmlIntialized) {
        throw new TypeError('Invalid argument: xml in SpawnEntity_Request');
      }
      if (!this._robot_namespaceIntialized) {
        throw new TypeError('Invalid argument: robot_namespace in SpawnEntity_Request');
      }
      if (!this._reference_frameIntialized) {
        throw new TypeError('Invalid argument: reference_frame in SpawnEntity_Request');
      }
    }
    if (own) {
    ...
    if (own) {
      this._wrapperFields.xml.freeze(own, checkConsistency);
    }
    this._refObject.xml = this._wrapperFields.xml.refObject;
    if (own) {
  ...
  deserialize(refObject) {
    ...
    this._xmlIntialized = true;
    this._wrapperFields.xml.data = refObject.xml.data;
    this._robot_namespaceIntialized = true;
  ...
  static freeStruct(refObject) {
    ...
    StringWrapper.freeStruct(refObject.xml);
  ...
  static type() {
    return {pkgName: 'gazebo_msgs', subFolder: 'srv', interfaceName: 'SpawnEntity_Request'};
  }
  static isPrimitive() {
    return false;
  }
  ...
  get xml() {
    ...
    return this._wrapperFields.xml.data;
  }
  set xml(value) {
    this._xmlIntialized = true;
    this._wrapperFields.xml.data = value;
  }
  get robot_namespace() {
    if (!this._robot_namespaceIntialized) {
      return undefined;
  ...
  copyRefObject(refObject) {
    ...
    this._xmlIntialized = true;
    this._wrapperFields.xml.copyRefObject(this._refObject.xml);
    this._robot_namespaceIntialized = true;
  ...
  copy(other) {
    ...
    this._xmlIntialized = true;
    this._wrapperFields.xml.copy(other._wrapperFields.xml);
    this._robot_namespaceIntialized = true;
