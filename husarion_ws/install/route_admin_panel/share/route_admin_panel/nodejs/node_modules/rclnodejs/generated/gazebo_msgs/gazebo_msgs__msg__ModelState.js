...
const ModelStateRefStruct = StructType({
...
const ModelStateRefArray = ArrayType(ModelStateRefStruct);
const ModelStateRefStructArray = StructType({
  data: ModelStateRefArray,
...
class ModelStateWrapper {
  constructor(other) {
    ...
    if (typeof other === 'object' && other._refObject) {
      this._refObject = new ModelStateRefStruct(other._refObject.toObject());
  ...
  _initMembers() {
    this._refObject = new ModelStateRefStruct();
  ...
  static createFromRefObject(refObject) {
    let self = new ModelStateWrapper();
    self.copyRefObject(refObject);
    return self;
  }
  static createArray() {
    return new ModelStateArrayWrapper;
  }
  static get ArrayType() {
    return ModelStateArrayWrapper;
  }
  static get refObjectArrayType() {
    return ModelStateRefStructArray
  }
  static get refObjectType() {
    return ModelStateRefStruct;
  }
  toRawROS() {
    this.freeze(true);
  ...
  freeze(own = false, checkConsistency = false) {
    if (checkConsistency) {
      if (!this._model_nameIntialized) {
        throw new TypeError('Invalid argument: model_name in ModelState');
      }
      if (!this._reference_frameIntialized) {
        throw new TypeError('Invalid argument: reference_frame in ModelState');
      }
    }
    if (own) {
  ...
  static destoryRawROS(msg) {
    ModelStateWrapper.freeStruct(msg.refObject);
  }
  static type() {
    return {pkgName: 'gazebo_msgs', subFolder: 'msg', interfaceName: 'ModelState'};
  }
  static isPrimitive() {
    return false;
  }
  ...
  copyRefObject(refObject) {
    this._refObject = new ModelStateRefStruct(refObject.toObject());
    this._model_nameIntialized = true;
...
class ModelStateArrayWrapper {
  ...
  fill(values) {
    ...
    values.forEach((value, index) => {
      if (value instanceof ModelStateWrapper) {
        ...
        this._wrappers[index] = new ModelStateWrapper(value);
      }
    });
  }
  ...
  set size(value) {
    if (typeof value != 'number') {
      throw new TypeError('Invalid argument: should provide a number to ModelStateArrayWrapper.size setter');
      return;
    }
  ...
  set capacity(value) {
    if (typeof value != 'number') {
      throw new TypeError('Invalid argument: should provide a number to ModelStateArrayWrapper.capacity setter');
    }
    return this._resize(value);
  }
  get refObject() {
  ...
  _resize(size) {
    ...
    this._refArray = new ModelStateRefArray(size);
    this._refObject = new ModelStateRefStructArray();
    this._refObject.size = size;
    this._refObject.capacity = size;
    this._wrappers = new Array();
    for (let i = 0; i < size; i++) {
      this._wrappers.push(new ModelStateWrapper());
    }
  }
  ...
  copy(other) {
    if (! (other instanceof ModelStateArrayWrapper)) {
      throw new TypeError('Invalid argument: should provide "ModelStateArrayWrapper".');
    }
  ...
  static freeArray(refObject) {
    ...
    for (let index = 0; index < refObject.size; index++) {
      ModelStateWrapper.freeStruct(refObjectArray[index]);
    }
  }
...
module.exports = ModelStateWrapper;
/*
