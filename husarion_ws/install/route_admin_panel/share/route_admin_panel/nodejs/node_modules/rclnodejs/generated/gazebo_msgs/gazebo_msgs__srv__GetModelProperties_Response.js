  ...
  static freeStruct(refObject) {
    ...
    if (refObject.body_names.size != 0) {
      ...
      if (StringWrapper.ArrayType.useTypedArray) {
        deallocator.delayFreeStructMember(refObject.body_names, StringWrapper.refObjectArrayType, 'data');
      } else {
    ...
    if (refObject.geom_names.size != 0) {
      ...
      if (StringWrapper.ArrayType.useTypedArray) {
        deallocator.delayFreeStructMember(refObject.geom_names, StringWrapper.refObjectArrayType, 'data');
      } else {
    ...
    if (refObject.child_model_names.size != 0) {
      ...
      if (StringWrapper.ArrayType.useTypedArray) {
        deallocator.delayFreeStructMember(refObject.child_model_names, StringWrapper.refObjectArrayType, 'data');
      } else {
