  ...
  static freeStruct(refObject) {
    ...
    if (refObject.bounded_sequence_of_arrays.size != 0) {
      ...
      if (ArraysWrapper.ArrayType.useTypedArray) {
        deallocator.delayFreeStructMember(refObject.bounded_sequence_of_arrays, ArraysWrapper.refObjectArrayType, 'data');
      } else {
    ...
    if (refObject.bounded_sequence_of_bounded_sequences.size != 0) {
      ...
      if (BoundedSequencesWrapper.ArrayType.useTypedArray) {
        deallocator.delayFreeStructMember(refObject.bounded_sequence_of_bounded_sequences, BoundedSequencesWrapper.refObjectArrayType, 'data');
      } else {
    ...
    if (refObject.bounded_sequence_of_unbounded_sequences.size != 0) {
      ...
      if (UnboundedSequencesWrapper.ArrayType.useTypedArray) {
        deallocator.delayFreeStructMember(refObject.bounded_sequence_of_unbounded_sequences, UnboundedSequencesWrapper.refObjectArrayType, 'data');
      } else {
    ...
    if (refObject.unbounded_sequence_of_arrays.size != 0) {
      ...
      if (ArraysWrapper.ArrayType.useTypedArray) {
        deallocator.delayFreeStructMember(refObject.unbounded_sequence_of_arrays, ArraysWrapper.refObjectArrayType, 'data');
      } else {
    ...
    if (refObject.unbounded_sequence_of_bounded_sequences.size != 0) {
      ...
      if (BoundedSequencesWrapper.ArrayType.useTypedArray) {
        deallocator.delayFreeStructMember(refObject.unbounded_sequence_of_bounded_sequences, BoundedSequencesWrapper.refObjectArrayType, 'data');
      } else {
    ...
    if (refObject.unbounded_sequence_of_unbounded_sequences.size != 0) {
      ...
      if (UnboundedSequencesWrapper.ArrayType.useTypedArray) {
        deallocator.delayFreeStructMember(refObject.unbounded_sequence_of_unbounded_sequences, UnboundedSequencesWrapper.refObjectArrayType, 'data');
      } else {
