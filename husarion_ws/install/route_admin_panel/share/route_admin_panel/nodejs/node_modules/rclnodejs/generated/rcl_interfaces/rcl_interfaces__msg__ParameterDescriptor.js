  ...
  static freeStruct(refObject) {
    ...
    if (refObject.floating_point_range.size != 0) {
      ...
      if (FloatingPointRangeWrapper.ArrayType.useTypedArray) {
        deallocator.delayFreeStructMember(refObject.floating_point_range, FloatingPointRangeWrapper.refObjectArrayType, 'data');
      } else {
    ...
    if (refObject.integer_range.size != 0) {
      ...
      if (IntegerRangeWrapper.ArrayType.useTypedArray) {
        deallocator.delayFreeStructMember(refObject.integer_range, IntegerRangeWrapper.refObjectArrayType, 'data');
      } else {
