...
const BoundedSequencesRefStruct = StructType({
...
const BoundedSequencesRefArray = ArrayType(BoundedSequencesRefStruct);
const BoundedSequencesRefStructArray = StructType({
  data: BoundedSequencesRefArray,
  size: ref.types.size_t,
  capacity: ref.types.size_t
});
// Define the wrapper class.
class BoundedSequencesWrapper {
  constructor(other) {
    this._wrapperFields = {};
    ...
    if (typeof other === 'object' && other._refObject) {
      this._refObject = new BoundedSequencesRefStruct(other._refObject.toObject());
  ...
  _initMembers() {
    this._refObject = new BoundedSequencesRefStruct();
    this._wrapperFields.bool_values = BoolWrapper.createArray();
    this._wrapperFields.byte_values = ByteWrapper.createArray();
    this._wrapperFields.char_values = CharWrapper.createArray();
    this._wrapperFields.float32_values = Float32Wrapper.createArray();
  ...
  static createFromRefObject(refObject) {
    let self = new BoundedSequencesWrapper();
    self.copyRefObject(refObject);
    return self;
  }
  static createArray() {
    return new BoundedSequencesArrayWrapper;
  }
  static get ArrayType() {
    return BoundedSequencesArrayWrapper;
  }
  static get refObjectArrayType() {
    return BoundedSequencesRefStructArray
  }
  static get refObjectType() {
    return BoundedSequencesRefStruct;
  }
  toRawROS() {
    this.freeze(true);
  ...
  freeze(own = false, checkConsistency = false) {
    if (checkConsistency) {
      if (!this._alignment_checkIntialized) {
        throw new TypeError('Invalid argument: alignment_check in BoundedSequences');
      }
    }
    if (!own) {
  ...
  static freeStruct(refObject) {
    if (refObject.bool_values.size != 0) {
      ...
      if (BoolWrapper.ArrayType.useTypedArray) {
        deallocator.delayFreeStructMember(refObject.bool_values, BoolWrapper.refObjectArrayType, 'data');
      } else {
    ...
    if (refObject.byte_values.size != 0) {
      ...
      if (ByteWrapper.ArrayType.useTypedArray) {
        deallocator.delayFreeStructMember(refObject.byte_values, ByteWrapper.refObjectArrayType, 'data');
      } else {
    ...
    if (refObject.char_values.size != 0) {
      ...
      if (CharWrapper.ArrayType.useTypedArray) {
        deallocator.delayFreeStructMember(refObject.char_values, CharWrapper.refObjectArrayType, 'data');
      } else {
    ...
    if (refObject.float32_values.size != 0) {
      ...
      if (Float32Wrapper.ArrayType.useTypedArray) {
        deallocator.delayFreeStructMember(refObject.float32_values, Float32Wrapper.refObjectArrayType, 'data');
      } else {
    ...
    if (refObject.float64_values.size != 0) {
      ...
      if (Float64Wrapper.ArrayType.useTypedArray) {
        deallocator.delayFreeStructMember(refObject.float64_values, Float64Wrapper.refObjectArrayType, 'data');
      } else {
    ...
    if (refObject.int8_values.size != 0) {
      ...
      if (Int8Wrapper.ArrayType.useTypedArray) {
        deallocator.delayFreeStructMember(refObject.int8_values, Int8Wrapper.refObjectArrayType, 'data');
      } else {
    ...
    if (refObject.uint8_values.size != 0) {
      ...
      if (UInt8Wrapper.ArrayType.useTypedArray) {
        deallocator.delayFreeStructMember(refObject.uint8_values, UInt8Wrapper.refObjectArrayType, 'data');
      } else {
    ...
    if (refObject.int16_values.size != 0) {
      ...
      if (Int16Wrapper.ArrayType.useTypedArray) {
        deallocator.delayFreeStructMember(refObject.int16_values, Int16Wrapper.refObjectArrayType, 'data');
      } else {
    ...
    if (refObject.uint16_values.size != 0) {
      ...
      if (UInt16Wrapper.ArrayType.useTypedArray) {
        deallocator.delayFreeStructMember(refObject.uint16_values, UInt16Wrapper.refObjectArrayType, 'data');
      } else {
    ...
    if (refObject.int32_values.size != 0) {
      ...
      if (Int32Wrapper.ArrayType.useTypedArray) {
        deallocator.delayFreeStructMember(refObject.int32_values, Int32Wrapper.refObjectArrayType, 'data');
      } else {
    ...
    if (refObject.uint32_values.size != 0) {
      ...
      if (UInt32Wrapper.ArrayType.useTypedArray) {
        deallocator.delayFreeStructMember(refObject.uint32_values, UInt32Wrapper.refObjectArrayType, 'data');
      } else {
    ...
    if (refObject.int64_values.size != 0) {
      ...
      if (Int64Wrapper.ArrayType.useTypedArray) {
        deallocator.delayFreeStructMember(refObject.int64_values, Int64Wrapper.refObjectArrayType, 'data');
      } else {
    ...
    if (refObject.uint64_values.size != 0) {
      ...
      if (UInt64Wrapper.ArrayType.useTypedArray) {
        deallocator.delayFreeStructMember(refObject.uint64_values, UInt64Wrapper.refObjectArrayType, 'data');
      } else {
    ...
    if (refObject.string_values.size != 0) {
      ...
      if (StringWrapper.ArrayType.useTypedArray) {
        deallocator.delayFreeStructMember(refObject.string_values, StringWrapper.refObjectArrayType, 'data');
      } else {
    ...
    if (refObject.basic_types_values.size != 0) {
      ...
      if (BasicTypesWrapper.ArrayType.useTypedArray) {
        deallocator.delayFreeStructMember(refObject.basic_types_values, BasicTypesWrapper.refObjectArrayType, 'data');
      } else {
    ...
    if (refObject.constants_values.size != 0) {
      ...
      if (ConstantsWrapper.ArrayType.useTypedArray) {
        deallocator.delayFreeStructMember(refObject.constants_values, ConstantsWrapper.refObjectArrayType, 'data');
      } else {
    ...
    if (refObject.defaults_values.size != 0) {
      ...
      if (DefaultsWrapper.ArrayType.useTypedArray) {
        deallocator.delayFreeStructMember(refObject.defaults_values, DefaultsWrapper.refObjectArrayType, 'data');
      } else {
    ...
    if (refObject.bool_values_default.size != 0) {
      ...
      if (BoolWrapper.ArrayType.useTypedArray) {
        deallocator.delayFreeStructMember(refObject.bool_values_default, BoolWrapper.refObjectArrayType, 'data');
      } else {
    ...
    if (refObject.byte_values_default.size != 0) {
      ...
      if (ByteWrapper.ArrayType.useTypedArray) {
        deallocator.delayFreeStructMember(refObject.byte_values_default, ByteWrapper.refObjectArrayType, 'data');
      } else {
    ...
    if (refObject.char_values_default.size != 0) {
      ...
      if (CharWrapper.ArrayType.useTypedArray) {
        deallocator.delayFreeStructMember(refObject.char_values_default, CharWrapper.refObjectArrayType, 'data');
      } else {
    ...
    if (refObject.float32_values_default.size != 0) {
      ...
      if (Float32Wrapper.ArrayType.useTypedArray) {
        deallocator.delayFreeStructMember(refObject.float32_values_default, Float32Wrapper.refObjectArrayType, 'data');
      } else {
    ...
    if (refObject.float64_values_default.size != 0) {
      ...
      if (Float64Wrapper.ArrayType.useTypedArray) {
        deallocator.delayFreeStructMember(refObject.float64_values_default, Float64Wrapper.refObjectArrayType, 'data');
      } else {
    ...
    if (refObject.int8_values_default.size != 0) {
      ...
      if (Int8Wrapper.ArrayType.useTypedArray) {
        deallocator.delayFreeStructMember(refObject.int8_values_default, Int8Wrapper.refObjectArrayType, 'data');
      } else {
    ...
    if (refObject.uint8_values_default.size != 0) {
      ...
      if (UInt8Wrapper.ArrayType.useTypedArray) {
        deallocator.delayFreeStructMember(refObject.uint8_values_default, UInt8Wrapper.refObjectArrayType, 'data');
      } else {
    ...
    if (refObject.int16_values_default.size != 0) {
      ...
      if (Int16Wrapper.ArrayType.useTypedArray) {
        deallocator.delayFreeStructMember(refObject.int16_values_default, Int16Wrapper.refObjectArrayType, 'data');
      } else {
    ...
    if (refObject.uint16_values_default.size != 0) {
      ...
      if (UInt16Wrapper.ArrayType.useTypedArray) {
        deallocator.delayFreeStructMember(refObject.uint16_values_default, UInt16Wrapper.refObjectArrayType, 'data');
      } else {
    ...
    if (refObject.int32_values_default.size != 0) {
      ...
      if (Int32Wrapper.ArrayType.useTypedArray) {
        deallocator.delayFreeStructMember(refObject.int32_values_default, Int32Wrapper.refObjectArrayType, 'data');
      } else {
    ...
    if (refObject.uint32_values_default.size != 0) {
      ...
      if (UInt32Wrapper.ArrayType.useTypedArray) {
        deallocator.delayFreeStructMember(refObject.uint32_values_default, UInt32Wrapper.refObjectArrayType, 'data');
      } else {
    ...
    if (refObject.int64_values_default.size != 0) {
      ...
      if (Int64Wrapper.ArrayType.useTypedArray) {
        deallocator.delayFreeStructMember(refObject.int64_values_default, Int64Wrapper.refObjectArrayType, 'data');
      } else {
    ...
    if (refObject.uint64_values_default.size != 0) {
      ...
      if (UInt64Wrapper.ArrayType.useTypedArray) {
        deallocator.delayFreeStructMember(refObject.uint64_values_default, UInt64Wrapper.refObjectArrayType, 'data');
      } else {
    ...
    if (refObject.string_values_default.size != 0) {
      ...
      if (StringWrapper.ArrayType.useTypedArray) {
        deallocator.delayFreeStructMember(refObject.string_values_default, StringWrapper.refObjectArrayType, 'data');
      } else {
  ...
  static destoryRawROS(msg) {
    BoundedSequencesWrapper.freeStruct(msg.refObject);
  }
  static type() {
    return {pkgName: 'test_msgs', subFolder: 'msg', interfaceName: 'BoundedSequences'};
  }
  static isPrimitive() {
    return false;
  }
  ...
  set bool_values(value) {
    if (value.length > 3) {
      throw new RangeError('The length of array bool_values must be <= 3.');
    }
  ...
  set byte_values(value) {
    if (value.length > 3) {
      throw new RangeError('The length of array byte_values must be <= 3.');
    }
  ...
  set char_values(value) {
    if (value.length > 3) {
      throw new RangeError('The length of array char_values must be <= 3.');
    }
  ...
  set float32_values(value) {
    if (value.length > 3) {
      throw new RangeError('The length of array float32_values must be <= 3.');
    }
  ...
  set float64_values(value) {
    if (value.length > 3) {
      throw new RangeError('The length of array float64_values must be <= 3.');
    }
  ...
  set int8_values(value) {
    if (value.length > 3) {
      throw new RangeError('The length of array int8_values must be <= 3.');
    }
  ...
  set uint8_values(value) {
    if (value.length > 3) {
      throw new RangeError('The length of array uint8_values must be <= 3.');
    }
  ...
  set int16_values(value) {
    if (value.length > 3) {
      throw new RangeError('The length of array int16_values must be <= 3.');
    }
  ...
  set uint16_values(value) {
    if (value.length > 3) {
      throw new RangeError('The length of array uint16_values must be <= 3.');
    }
  ...
  set int32_values(value) {
    if (value.length > 3) {
      throw new RangeError('The length of array int32_values must be <= 3.');
    }
  ...
  set uint32_values(value) {
    if (value.length > 3) {
      throw new RangeError('The length of array uint32_values must be <= 3.');
    }
  ...
  set int64_values(value) {
    if (value.length > 3) {
      throw new RangeError('The length of array int64_values must be <= 3.');
    }
  ...
  set uint64_values(value) {
    if (value.length > 3) {
      throw new RangeError('The length of array uint64_values must be <= 3.');
    }
  ...
  set string_values(value) {
    if (value.length > 3) {
      throw new RangeError('The length of array string_values must be <= 3.');
    }
  ...
  set basic_types_values(value) {
    if (value.length > 3) {
      throw new RangeError('The length of array basic_types_values must be <= 3.');
    }
  ...
  set constants_values(value) {
    if (value.length > 3) {
      throw new RangeError('The length of array constants_values must be <= 3.');
    }
  ...
  set defaults_values(value) {
    if (value.length > 3) {
      throw new RangeError('The length of array defaults_values must be <= 3.');
    }
  ...
  set bool_values_default(value) {
    if (value.length > 3) {
      throw new RangeError('The length of array bool_values_default must be <= 3.');
    }
  ...
  set byte_values_default(value) {
    if (value.length > 3) {
      throw new RangeError('The length of array byte_values_default must be <= 3.');
    }
  ...
  set char_values_default(value) {
    if (value.length > 3) {
      throw new RangeError('The length of array char_values_default must be <= 3.');
    }
  ...
  set float32_values_default(value) {
    if (value.length > 3) {
      throw new RangeError('The length of array float32_values_default must be <= 3.');
    }
  ...
  set float64_values_default(value) {
    if (value.length > 3) {
      throw new RangeError('The length of array float64_values_default must be <= 3.');
    }
  ...
  set int8_values_default(value) {
    if (value.length > 3) {
      throw new RangeError('The length of array int8_values_default must be <= 3.');
    }
  ...
  set uint8_values_default(value) {
    if (value.length > 3) {
      throw new RangeError('The length of array uint8_values_default must be <= 3.');
    }
  ...
  set int16_values_default(value) {
    if (value.length > 3) {
      throw new RangeError('The length of array int16_values_default must be <= 3.');
    }
  ...
  set uint16_values_default(value) {
    if (value.length > 3) {
      throw new RangeError('The length of array uint16_values_default must be <= 3.');
    }
  ...
  set int32_values_default(value) {
    if (value.length > 3) {
      throw new RangeError('The length of array int32_values_default must be <= 3.');
    }
  ...
  set uint32_values_default(value) {
    if (value.length > 3) {
      throw new RangeError('The length of array uint32_values_default must be <= 3.');
    }
  ...
  set int64_values_default(value) {
    if (value.length > 3) {
      throw new RangeError('The length of array int64_values_default must be <= 3.');
    }
  ...
  set uint64_values_default(value) {
    if (value.length > 3) {
      throw new RangeError('The length of array uint64_values_default must be <= 3.');
    }
  ...
  set string_values_default(value) {
    if (value.length > 3) {
      throw new RangeError('The length of array string_values_default must be <= 3.');
    }
  ...
  copyRefObject(refObject) {
    this._refObject = new BoundedSequencesRefStruct(refObject.toObject());
    refObject.bool_values.data.length = refObject.bool_values.size;
    for (let index = 0; index < refObject.bool_values.size; index++) {
      this._bool_valuesArray[index] = refObject.bool_values.data[index].data;
    }
  ...
  static get classType() {
    return BoundedSequencesWrapper;
  }
  static get ROSMessageDef() {
    return {"constants":[],"fields":[{"name":"bool_values","type":{"isArray":true,"arraySize":3,"isUpperBound":true,"isDynamicArray":true,"isFixedSizeArray":false,"pkgName":null,"type":"bool","stringUpperBound":null,"isPrimitiveType":true},"default_value":null},{"name":"byte_values","type":{"isArray":true,"arraySize":3,"isUpperBound":true,"isDynamicArray":true,"isFixedSizeArray":false,"pkgName":null,"type":"byte","stringUpperBound":null,"isPrimitiveType":true},"default_value":null},{"name":"char_values","type":{"isArray":true,"arraySize":3,"isUpperBound":true,"isDynamicArray":true,"isFixedSizeArray":false,"pkgName":null,"type":"char","stringUpperBound":null,"isPrimitiveType":true},"default_value":null},{"name":"float32_values","type":{"isArray":true,"arraySize":3,"isUpperBound":true,"isDynamicArray":true,"isFixedSizeArray":false,"pkgName":null,"type":"float32","stringUpperBound":null,"isPrimitiveType":true},"default_value":null},{"name":"float64_values","type":{"isArray":true,"arraySize":3,"isUpperBound":true,"isDynamicArray":true,"isFixedSizeArray":false,"pkgName":null,"type":"float64","stringUpperBound":null,"isPrimitiveType":true},"default_value":null},{"name":"int8_values","type":{"isArray":true,"arraySize":3,"isUpperBound":true,"isDynamicArray":true,"isFixedSizeArray":false,"pkgName":null,"type":"int8","stringUpperBound":null,"isPrimitiveType":true},"default_value":null},{"name":"uint8_values","type":{"isArray":true,"arraySize":3,"isUpperBound":true,"isDynamicArray":true,"isFixedSizeArray":false,"pkgName":null,"type":"uint8","stringUpperBound":null,"isPrimitiveType":true},"default_value":null},{"name":"int16_values","type":{"isArray":true,"arraySize":3,"isUpperBound":true,"isDynamicArray":true,"isFixedSizeArray":false,"pkgName":null,"type":"int16","stringUpperBound":null,"isPrimitiveType":true},"default_value":null},{"name":"uint16_values","type":{"isArray":true,"arraySize":3,"isUpperBound":true,"isDynamicArray":true,"isFixedSizeArray":false,"pkgName":null,"type":"uint16","stringUpperBound":null,"isPrimitiveType":true},"default_value":null},{"name":"int32_values","type":{"isArray":true,"arraySize":3,"isUpperBound":true,"isDynamicArray":true,"isFixedSizeArray":false,"pkgName":null,"type":"int32","stringUpperBound":null,"isPrimitiveType":true},"default_value":null},{"name":"uint32_values","type":{"isArray":true,"arraySize":3,"isUpperBound":true,"isDynamicArray":true,"isFixedSizeArray":false,"pkgName":null,"type":"uint32","stringUpperBound":null,"isPrimitiveType":true},"default_value":null},{"name":"int64_values","type":{"isArray":true,"arraySize":3,"isUpperBound":true,"isDynamicArray":true,"isFixedSizeArray":false,"pkgName":null,"type":"int64","stringUpperBound":null,"isPrimitiveType":true},"default_value":null},{"name":"uint64_values","type":{"isArray":true,"arraySize":3,"isUpperBound":true,"isDynamicArray":true,"isFixedSizeArray":false,"pkgName":null,"type":"uint64","stringUpperBound":null,"isPrimitiveType":true},"default_value":null},{"name":"string_values","type":{"isArray":true,"arraySize":3,"isUpperBound":true,"isDynamicArray":true,"isFixedSizeArray":false,"pkgName":null,"type":"string","stringUpperBound":null,"isPrimitiveType":true},"default_value":null},{"name":"basic_types_values","type":{"isArray":true,"arraySize":3,"isUpperBound":true,"isDynamicArray":true,"isFixedSizeArray":false,"pkgName":"test_msgs","type":"BasicTypes","stringUpperBound":null,"isPrimitiveType":false},"default_value":null},{"name":"constants_values","type":{"isArray":true,"arraySize":3,"isUpperBound":true,"isDynamicArray":true,"isFixedSizeArray":false,"pkgName":"test_msgs","type":"Constants","stringUpperBound":null,"isPrimitiveType":false},"default_value":null},{"name":"defaults_values","type":{"isArray":true,"arraySize":3,"isUpperBound":true,"isDynamicArray":true,"isFixedSizeArray":false,"pkgName":"test_msgs","type":"Defaults","stringUpperBound":null,"isPrimitiveType":false},"default_value":null},{"name":"bool_values_default","type":{"isArray":true,"arraySize":3,"isUpperBound":true,"isDynamicArray":true,"isFixedSizeArray":false,"pkgName":null,"type":"bool","stringUpperBound":null,"isPrimitiveType":true},"default_value":[false,true,false]},{"name":"byte_values_default","type":{"isArray":true,"arraySize":3,"isUpperBound":true,"isDynamicArray":true,"isFixedSizeArray":false,"pkgName":null,"type":"byte","stringUpperBound":null,"isPrimitiveType":true},"default_value":[0,1,255]},{"name":"char_values_default","type":{"isArray":true,"arraySize":3,"isUpperBound":true,"isDynamicArray":true,"isFixedSizeArray":false,"pkgName":null,"type":"char","stringUpperBound":null,"isPrimitiveType":true},"default_value":[0,1,127]},{"name":"float32_values_default","type":{"isArray":true,"arraySize":3,"isUpperBound":true,"isDynamicArray":true,"isFixedSizeArray":false,"pkgName":null,"type":"float32","stringUpperBound":null,"isPrimitiveType":true},"default_value":[1.125,0,-1.125]},{"name":"float64_values_default","type":{"isArray":true,"arraySize":3,"isUpperBound":true,"isDynamicArray":true,"isFixedSizeArray":false,"pkgName":null,"type":"float64","stringUpperBound":null,"isPrimitiveType":true},"default_value":[3.1415,0,-3.1415]},{"name":"int8_values_default","type":{"isArray":true,"arraySize":3,"isUpperBound":true,"isDynamicArray":true,"isFixedSizeArray":false,"pkgName":null,"type":"int8","stringUpperBound":null,"isPrimitiveType":true},"default_value":[0,127,-128]},{"name":"uint8_values_default","type":{"isArray":true,"arraySize":3,"isUpperBound":true,"isDynamicArray":true,"isFixedSizeArray":false,"pkgName":null,"type":"uint8","stringUpperBound":null,"isPrimitiveType":true},"default_value":[0,1,255]},{"name":"int16_values_default","type":{"isArray":true,"arraySize":3,"isUpperBound":true,"isDynamicArray":true,"isFixedSizeArray":false,"pkgName":null,"type":"int16","stringUpperBound":null,"isPrimitiveType":true},"default_value":[0,32767,-32768]},{"name":"uint16_values_default","type":{"isArray":true,"arraySize":3,"isUpperBound":true,"isDynamicArray":true,"isFixedSizeArray":false,"pkgName":null,"type":"uint16","stringUpperBound":null,"isPrimitiveType":true},"default_value":[0,1,65535]},{"name":"int32_values_default","type":{"isArray":true,"arraySize":3,"isUpperBound":true,"isDynamicArray":true,"isFixedSizeArray":false,"pkgName":null,"type":"int32","stringUpperBound":null,"isPrimitiveType":true},"default_value":[0,2147483647,-2147483648]},{"name":"uint32_values_default","type":{"isArray":true,"arraySize":3,"isUpperBound":true,"isDynamicArray":true,"isFixedSizeArray":false,"pkgName":null,"type":"uint32","stringUpperBound":null,"isPrimitiveType":true},"default_value":[0,1,4294967295]},{"name":"int64_values_default","type":{"isArray":true,"arraySize":3,"isUpperBound":true,"isDynamicArray":true,"isFixedSizeArray":false,"pkgName":null,"type":"int64","stringUpperBound":null,"isPrimitiveType":true},"default_value":[0,9223372036854776000,-9223372036854776000]},{"name":"uint64_values_default","type":{"isArray":true,"arraySize":3,"isUpperBound":true,"isDynamicArray":true,"isFixedSizeArray":false,"pkgName":null,"type":"uint64","stringUpperBound":null,"isPrimitiveType":true},"default_value":[0,1,18446744073709552000]},{"name":"string_values_default","type":{"isArray":true,"arraySize":3,"isUpperBound":true,"isDynamicArray":true,"isFixedSizeArray":false,"pkgName":null,"type":"string","stringUpperBound":null,"isPrimitiveType":true},"default_value":["","max value","min value"]},{"name":"alignment_check","type":{"isArray":false,"arraySize":null,"isUpperBound":false,"isDynamicArray":false,"isFixedSizeArray":false,"pkgName":null,"type":"int32","stringUpperBound":null,"isPrimitiveType":true},"default_value":null}],"baseType":{"pkgName":"test_msgs","type":"BoundedSequences","stringUpperBound":null,"isPrimitiveType":false},"msgName":"BoundedSequences"};
  }
  hasMember(name) {
...
class BoundedSequencesArrayWrapper {
  constructor(size = 0) {
    this._resize(size);
  }
  toRawROS() {
  ...
  fill(values) {
    ...
    values.forEach((value, index) => {
      if (value instanceof BoundedSequencesWrapper) {
        this._wrappers[index].copy(value);
      } else {
        this._wrappers[index] = new BoundedSequencesWrapper(value);
      }
    });
  }
  ...
  set size(value) {
    if (typeof value != 'number') {
      throw new TypeError('Invalid argument: should provide a number to BoundedSequencesArrayWrapper.size setter');
      return;
    }
  ...
  set capacity(value) {
    if (typeof value != 'number') {
      throw new TypeError('Invalid argument: should provide a number to BoundedSequencesArrayWrapper.capacity setter');
    }
    return this._resize(value);
  }
  get refObject() {
  ...
  _resize(size) {
    ...
    this._refArray = new BoundedSequencesRefArray(size);
    this._refObject = new BoundedSequencesRefStructArray();
    this._refObject.size = size;
    this._refObject.capacity = size;
    this._wrappers = new Array();
    for (let i = 0; i < size; i++) {
      this._wrappers.push(new BoundedSequencesWrapper());
    }
  }
  ...
  copy(other) {
    if (! (other instanceof BoundedSequencesArrayWrapper)) {
      throw new TypeError('Invalid argument: should provide "BoundedSequencesArrayWrapper".');
    }
  ...
  static freeArray(refObject) {
    ...
    for (let index = 0; index < refObject.size; index++) {
      BoundedSequencesWrapper.freeStruct(refObjectArray[index]);
    }
  }
...
module.exports = BoundedSequencesWrapper;
/*
