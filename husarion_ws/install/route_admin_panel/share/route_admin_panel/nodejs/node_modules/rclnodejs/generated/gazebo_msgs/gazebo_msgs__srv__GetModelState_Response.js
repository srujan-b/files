...
const GetModelState_ResponseRefStruct = StructType({
...
const GetModelState_ResponseRefArray = ArrayType(GetModelState_ResponseRefStruct);
const GetModelState_ResponseRefStructArray = StructType({
  data: GetModelState_ResponseRefArray,
  size: ref.types.size_t,
  capacity: ref.types.size_t
});
// Define the wrapper class.
class GetModelState_ResponseWrapper {
  constructor(other) {
    this._wrapperFields = {};
    if (typeof other === 'object' && other._refObject) {
      this._refObject = new GetModelState_ResponseRefStruct(other._refObject.toObject());
  ...
  _initMembers() {
    this._refObject = new GetModelState_ResponseRefStruct();
  ...
  static createFromRefObject(refObject) {
    let self = new GetModelState_ResponseWrapper();
    self.copyRefObject(refObject);
    return self;
  }
  static createArray() {
    return new GetModelState_ResponseArrayWrapper;
  }
  static get ArrayType() {
    return GetModelState_ResponseArrayWrapper;
  }
  static get refObjectArrayType() {
    return GetModelState_ResponseRefStructArray
  }
  static get refObjectType() {
    return GetModelState_ResponseRefStruct;
  }
  toRawROS() {
    this.freeze(true);
  ...
  freeze(own = false, checkConsistency = false) {
    if (checkConsistency) {
      if (!this._successIntialized) {
        throw new TypeError('Invalid argument: success in GetModelState_Response');
      }
      if (!this._status_messageIntialized) {
        throw new TypeError('Invalid argument: status_message in GetModelState_Response');
      }
    }
  ...
  static destoryRawROS(msg) {
    GetModelState_ResponseWrapper.freeStruct(msg.refObject);
  }
  static type() {
    return {pkgName: 'gazebo_msgs', subFolder: 'srv', interfaceName: 'GetModelState_Response'};
  }
  static isPrimitive() {
    return false;
  }
  ...
  copyRefObject(refObject) {
    this._refObject = new GetModelState_ResponseRefStruct(refObject.toObject());
...
class GetModelState_ResponseArrayWrapper {
  ...
  fill(values) {
    ...
    values.forEach((value, index) => {
      if (value instanceof GetModelState_ResponseWrapper) {
        this._wrappers[index].copy(value);
      } else {
        this._wrappers[index] = new GetModelState_ResponseWrapper(value);
      }
    });
  }
  ...
  set size(value) {
    if (typeof value != 'number') {
      throw new TypeError('Invalid argument: should provide a number to GetModelState_ResponseArrayWrapper.size setter');
      return;
    }
  ...
  set capacity(value) {
    if (typeof value != 'number') {
      throw new TypeError('Invalid argument: should provide a number to GetModelState_ResponseArrayWrapper.capacity setter');
    }
    return this._resize(value);
  }
  get refObject() {
  ...
  _resize(size) {
    ...
    this._refArray = new GetModelState_ResponseRefArray(size);
    this._refObject = new GetModelState_ResponseRefStructArray();
    this._refObject.size = size;
    this._refObject.capacity = size;
    this._wrappers = new Array();
    for (let i = 0; i < size; i++) {
      this._wrappers.push(new GetModelState_ResponseWrapper());
    }
  }
  ...
  copy(other) {
    if (! (other instanceof GetModelState_ResponseArrayWrapper)) {
      throw new TypeError('Invalid argument: should provide "GetModelState_ResponseArrayWrapper".');
    }
  ...
  static freeArray(refObject) {
    ...
    for (let index = 0; index < refObject.size; index++) {
      GetModelState_ResponseWrapper.freeStruct(refObjectArray[index]);
    }
  }
...
module.exports = GetModelState_ResponseWrapper;
/*
 * The following is the original spec object coming from parser:
{
  ...
  "baseType": {
    "pkgName": "gazebo_msgs",
    "type": "GetModelState_Response",
    "stringUpperBound": null,
    "isPrimitiveType": false
  },
  "msgName": "GetModelState_Response"
}
*/
