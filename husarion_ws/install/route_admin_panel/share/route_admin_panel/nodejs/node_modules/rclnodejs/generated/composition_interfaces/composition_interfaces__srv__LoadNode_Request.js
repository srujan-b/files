  ...
  static freeStruct(refObject) {
    ...
    if (refObject.remap_rules.size != 0) {
      ...
      if (StringWrapper.ArrayType.useTypedArray) {
        deallocator.delayFreeStructMember(refObject.remap_rules, StringWrapper.refObjectArrayType, 'data');
      } else {
    ...
    if (refObject.extra_arguments.size != 0) {
      ...
      if (ParameterWrapper.ArrayType.useTypedArray) {
        deallocator.delayFreeStructMember(refObject.extra_arguments, ParameterWrapper.refObjectArrayType, 'data');
      } else {
