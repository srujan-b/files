...
const ArraysRefStruct = StructType({
...
const ArraysRefArray = ArrayType(ArraysRefStruct);
const ArraysRefStructArray = StructType({
  data: ArraysRefArray,
...
class ArraysWrapper {
  constructor(other) {
    ...
    if (typeof other === 'object' && other._refObject) {
      this._refObject = new ArraysRefStruct(other._refObject.toObject());
  ...
  _initMembers() {
    this._refObject = new ArraysRefStruct();
    this._wrapperFields.bool_values = BoolWrapper.createArray();
    this._wrapperFields.byte_values = ByteWrapper.createArray();
    this._wrapperFields.char_values = CharWrapper.createArray();
    this._wrapperFields.float32_values = Float32Wrapper.createArray();
  ...
  static createFromRefObject(refObject) {
    let self = new ArraysWrapper();
    self.copyRefObject(refObject);
    return self;
  }
  static createArray() {
    return new ArraysArrayWrapper;
  }
  static get ArrayType() {
    return ArraysArrayWrapper;
  }
  static get refObjectArrayType() {
    return ArraysRefStructArray
  }
  static get refObjectType() {
    return ArraysRefStruct;
  }
  toRawROS() {
    this.freeze(true);
  ...
  freeze(own = false, checkConsistency = false) {
    if (checkConsistency) {
      if (!this._alignment_checkIntialized) {
        throw new TypeError('Invalid argument: alignment_check in Arrays');
      }
    }
  ...
  static destoryRawROS(msg) {
    ArraysWrapper.freeStruct(msg.refObject);
  }
  static type() {
    return {pkgName: 'test_msgs', subFolder: 'msg', interfaceName: 'Arrays'};
  }
  static isPrimitive() {
    return false;
  }
  ...
  copyRefObject(refObject) {
    this._refObject = new ArraysRefStruct(refObject.toObject());
...
class ArraysArrayWrapper {
  ...
  fill(values) {
    ...
    values.forEach((value, index) => {
      if (value instanceof ArraysWrapper) {
        this._wrappers[index].copy(value);
      } else {
        this._wrappers[index] = new ArraysWrapper(value);
      }
    });
  }
  ...
  set size(value) {
    if (typeof value != 'number') {
      throw new TypeError('Invalid argument: should provide a number to ArraysArrayWrapper.size setter');
      return;
    }
  ...
  set capacity(value) {
    if (typeof value != 'number') {
      throw new TypeError('Invalid argument: should provide a number to ArraysArrayWrapper.capacity setter');
    }
    return this._resize(value);
  }
  get refObject() {
  ...
  _resize(size) {
    ...
    this._refArray = new ArraysRefArray(size);
    this._refObject = new ArraysRefStructArray();
    this._refObject.size = size;
    this._refObject.capacity = size;
    this._wrappers = new Array();
    for (let i = 0; i < size; i++) {
      this._wrappers.push(new ArraysWrapper());
    }
  }
  ...
  copy(other) {
    if (! (other instanceof ArraysArrayWrapper)) {
      throw new TypeError('Invalid argument: should provide "ArraysArrayWrapper".');
    }
  ...
  static freeArray(refObject) {
    ...
    for (let index = 0; index < refObject.size; index++) {
      ArraysWrapper.freeStruct(refObjectArray[index]);
    }
  }
