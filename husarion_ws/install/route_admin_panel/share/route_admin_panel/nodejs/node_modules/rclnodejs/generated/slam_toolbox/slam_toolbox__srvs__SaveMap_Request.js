...
const SaveMap_RequestRefStruct = StructType({
  name: StringWrapper.refObjectType,
});
...
class SaveMap_RequestWrapper {
  ...
  deserialize(refObject) {
    this._wrapperFields.name.copyRefObject(refObject.name);
  }
  ...
  static type() {
    return {pkgName: 'slam_toolbox', subFolder: 'srvs', interfaceName: 'SaveMap_Request'};
  }
  static isPrimitive() {
    return false;
  }
  ...
  get name() {
    return this._wrapperFields.name;
  }
  set name(value) {
    if (value instanceof StringWrapper) {
      this._wrapperFields.name.copy(value);
    } else {
      this._wrapperFields.name.copy(new StringWrapper(value));
    }
  }
