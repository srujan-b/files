...
class GetMapROI_ResponseWrapper {
  ...
  set sub_map(value) {
    if (value instanceof OccupancyGridWrapper) {
      ...
      this._wrapperFields.sub_map.copy(new OccupancyGridWrapper(value));
    }
  }
...
class GetMapROI_ResponseArrayWrapper {
  ...
  fill(values) {
    ...
    values.forEach((value, index) => {
      if (value instanceof GetMapROI_ResponseWrapper) {
        this._wrappers[index].copy(value);
      } else {
        this._wrappers[index] = new GetMapROI_ResponseWrapper(value);
      }
    });
  }
