  ...
  static freeStruct(refObject) {
    if (refObject.bounded_sequence_of_wstrings.size != 0) {
      ...
      if (StringWrapper.ArrayType.useTypedArray) {
        deallocator.delayFreeStructMember(refObject.bounded_sequence_of_wstrings, StringWrapper.refObjectArrayType, 'data');
      } else {
    ...
    if (refObject.unbounded_sequence_of_wstrings.size != 0) {
      ...
      if (StringWrapper.ArrayType.useTypedArray) {
        deallocator.delayFreeStructMember(refObject.unbounded_sequence_of_wstrings, StringWrapper.refObjectArrayType, 'data');
      } else {
