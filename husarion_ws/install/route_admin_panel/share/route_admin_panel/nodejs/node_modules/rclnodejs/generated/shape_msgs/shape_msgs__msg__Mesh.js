...
class MeshWrapper {
  ...
  static get ROSMessageDef() {
    return {"constants":[],"fields":[{"name":"triangles","type":{"isArray":true,"arraySize":null,"isUpperBound":false,"isDynamicArray":true,"isFixedSizeArray":null,"pkgName":"shape_msgs","type":"MeshTriangle","stringUpperBound":null,"isPrimitiveType":false},"default_value":null},{"name":"vertices","type":{"isArray":true,"arraySize":null,"isUpperBound":false,"isDynamicArray":true,"isFixedSizeArray":null,"pkgName":"geometry_msgs","type":"Point","stringUpperBound":null,"isPrimitiveType":false},"default_value":null}],"baseType":{"pkgName":"shape_msgs","type":"Mesh","stringUpperBound":null,"isPrimitiveType":false},"msgName":"Mesh"};
  }
  hasMember(name) {
  ...
  fill(values) {
    ...
    values.forEach((value, index) => {
      if (value instanceof MeshWrapper) {
        ...
        this._wrappers[index] = new MeshWrapper(value);
      }
    });
  }
