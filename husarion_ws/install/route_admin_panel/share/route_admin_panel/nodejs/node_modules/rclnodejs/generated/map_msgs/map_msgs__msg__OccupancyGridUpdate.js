...
class OccupancyGridUpdateArrayWrapper {
  ...
  fill(values) {
    ...
    values.forEach((value, index) => {
      if (value instanceof OccupancyGridUpdateWrapper) {
        this._wrappers[index].copy(value);
      } else {
        this._wrappers[index] = new OccupancyGridUpdateWrapper(value);
      }
    });
  }
